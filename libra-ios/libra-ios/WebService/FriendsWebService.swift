...
// MARK: - Private
private func getAllFriends(for userID: Int) -> Future<Result<[Person], NetworkError>> {
...
private func getFriend(with parameters: FriendshipParameters) -> Future<Result<Person, NetworkError>> {
