...
func sanitizeError(for response: DataTaskResponse) throws -> DataTaskResponse {
...
func sanitizeData(for response: DataTaskResponse) throws -> DataTaskResponse {
...
func sanitizeURLResponse(for response: DataTaskResponse) throws -> DataTaskResponse {
...
func unwrapDataAfterSanitizing(for response: DataTaskResponse) throws -> Data {
